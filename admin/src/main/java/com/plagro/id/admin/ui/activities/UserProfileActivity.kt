...
import com.plagro.id.admin.databinding.ActivityUserProfileBinding
...
class UserProfileActivity : BaseActivity(), View.OnClickListener {
    ...
    private lateinit var mUserDetails: Admin
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mUserDetails.profileCompleted == 0) {
            ...
            binding.etFirstName.setText(mUserDetails.retailName)
...
//            }
    ...
    private fun updateUserProfileDetails() {
        ...
        val adminHashMap = HashMap<String, Any>()

        // Get the FirstName from editText and trim the space
        val retailName = binding.etFirstName.text.toString().trim { it <= ' ' }
        if (retailName != mUserDetails.retailName) {
            adminHashMap[Constants.FIRST_NAME] = retailName
        }

        // Get the LastName from editText and trim the space
//        val lastName = binding.etLastName.text.toString().trim { it <= ' ' }
////        if (lastName != mUserDetails.lastName) {
////            adminHashMap[Constants.LAST_NAME] = lastName
////        }
        ...
        if (mobileNumber.isNotEmpty() && mobileNumber != mUserDetails.mobile.toString()) {
            adminHashMap[Constants.MOBILE] = mobileNumber.toLong()
        }

//        if (gender.isNotEmpty() && gender != mUserDetails.gender) {
//            adminHashMap[Constants.GENDER] = gender
//        }
        ...
        if (mUserDetails.profileCompleted == 0) {
            adminHashMap[Constants.COMPLETE_PROFILE] = 1
        }

        // call the registerUser function of FireStore class to make an entry in the database.
        FirestoreClass().updateAdminProfileData(
            this@UserProfileActivity,
            adminHashMap
        )
    }
