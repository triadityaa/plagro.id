package com.plagro.id.admin.firestore
...
import com.plagro.id.admin.*
import com.plagro.id.admin.ui.fragments.DashboardFragment
import com.plagro.id.admin.ui.fragments.OrdersFragment
import com.plagro.id.admin.ui.fragments.ProductsFragment
import com.plagro.id.admin.ui.fragments.SoldProductsFragment
import com.plagro.id.admin.firestore.*
import com.plagro.id.admin.ui.*
...
import com.plagro.id.admin.models.*
import com.plagro.id.admin.ui.activities.*
...
class FirestoreClass {
    ...
    fun registerAdmin(activity: RegisterActivity, adminInfo: Admin) {
        ...
        mFireStore.collection(Constants.ADMIN)
            // Document ID for users fields. Here the document it is the Admin ID.
            .document(adminInfo.id)
     ...
     */
    fun updateAdminProfileData(activity: Activity, adminHashMap: HashMap<String, Any>) {
        // Collection Name
        mFireStore.collection(Constants.ADMIN)
...
//    }
    ...
    fun getSoldProductsList(activity: SoldReportActivity) {
        // The collection name for SOLD PRODUCTS
        mFireStore.collection(Constants.SOLD_PRODUCTS)
            .whereEqualTo(Constants.ADMIN_ID, getCurrentUserID())
            .get() // Will get the documents snapshots.
